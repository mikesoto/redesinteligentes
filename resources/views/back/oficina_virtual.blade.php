...
<div class="row"> 
  ...
  <div id="office-main-content" class="col-sm-9 office-main-content">
    ...
    @if ($cur_user->id == 1)
      <?php $filt_color = (isset($_GET['u']) || isset($_GET['p']))? 'info' : 'default'; ?>
      <div id="filters-container" class="col-sm-12">
        <div id="panel-de-control" class="panel panel-{{$filt_color}}">
          <div class="panel-heading">
            <h3 class="panel-title">Filtrar por usuario y/o Periodo</h3>
          </div>
          <div class="panel-body">
            <form id="filters-form" method="GET" action="/oficina-virtual">
              ...
              <div class="col-sm-1">
                <input type="text" class="form-control" id="filterusr" name="u" size="4" value="{{(isset($_GET['u']) || isset($_GET['p']))? $req_u : ''}}">
              </div>
