                              ...
                              $soc3L = makeLadoRow($tree,3,$soc2L,'left');
                                $soc4L = makeLadoRow($tree,4,$soc3L,'left');
                                  $soc5L = makeLadoRow($tree,5,$soc4L,'left');
                                    $soc6L = makeLadoRow($tree,6,$soc5L,'left');
                                      $soc7L = makeLadoRow($tree,7,$soc6L,'left');
                                        $soc8L = makeLadoRow($tree,8,$soc7L,'left');
                                        $soc8R = makeLadoRow($tree,8,$soc7L,'right');
                                      $soc7R = makeLadoRow($tree,7,$soc6L,'right');
                                        $soc8L = makeLadoRow($tree,8,$soc7R,'left');
                                        $soc8R = makeLadoRow($tree,8,$soc7R,'right');
                                    $soc6R = makeLadoRow($tree,6,$soc5L,'right');
                                      $soc7L = makeLadoRow($tree,7,$soc6R,'left');
                                        $soc8L = makeLadoRow($tree,8,$soc7L,'left');
                                        $soc8R = makeLadoRow($tree,8,$soc7L,'right');
                                      $soc7R = makeLadoRow($tree,7,$soc6R,'right');
                                        $soc8L = makeLadoRow($tree,8,$soc7R,'left');
                                        $soc8R = makeLadoRow($tree,8,$soc7R,'right');
                                  $soc5R = makeLadoRow($tree,5,$soc4L,'right');
                                    $soc6L = makeLadoRow($tree,6,$soc5R,'left');
                                      $soc7L = makeLadoRow($tree,7,$soc6L,'left');
                                        $soc8L = makeLadoRow($tree,8,$soc7L,'left');
                                        $soc8R = makeLadoRow($tree,8,$soc7L,'right');
                                      $soc7R = makeLadoRow($tree,7,$soc6L,'right');
                                        $soc8L = makeLadoRow($tree,8,$soc7R,'left');
                                        $soc8R = makeLadoRow($tree,8,$soc7R,'right');
                                    $soc6R = makeLadoRow($tree,6,$soc5R,'right');
                                      $soc7L = makeLadoRow($tree,7,$soc6R,'left');
                                        $soc8L = makeLadoRow($tree,8,$soc7L,'left');
                                        $soc8R = makeLadoRow($tree,8,$soc7L,'right');
                                      $soc7R = makeLadoRow($tree,7,$soc6R,'right');
                  ...
                  <table id="red-table-right" class="table table-hover">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $soc0L = makeLadoRow($tree,0,$cur_user->id,'right');
                          $soc1L = makeLadoRow($tree,1,$soc0L,'left');
                            $soc2L = makeLadoRow($tree,2,$soc1L,'left');
                              $soc3L = makeLadoRow($tree,3,$soc2L,'left');
                                $soc4L = makeLadoRow($tree,4,$soc3L,'left');
